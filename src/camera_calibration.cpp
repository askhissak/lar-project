...
//Save camera parameters into intrinsic_calibration.xml
...
//Loop through the input images and calibrate
int calibrateCamera()
{
    //Read the settings from the default.xml
    Settings s;
    const string inputSettingsFile = "config/default.xml";
